...
-- Guarda quién hizo qué cambio y cuándo. Solo lo ven las cuentas con acceso
-- completo (admin, jefe y Dariana).
...
-- Solo las cuentas con acceso completo pueden LEER el log
